...
export function AppShell({ email, offline, onLogout, children }: Props) {
  ...
  useEffect(() => {
    const targets: Array<[string, string]> = [
      ["dashboard", ".app-shell"],
      ["wallets", ".layout-grid"],
      ["family", '[aria-labelledby="backup-restore-title"]'],
    ];
    ...
    <div className="app-frame">
      <aside className="app-sidebar" aria-label="Primary navigation">
        <div className="brand-lockup">
          <span className="eyebrow">Arta</span>
          <strong>Household money, remembered.</strong>
        </div>
        <div className="shell-household">
          <span className="muted">Active household</span>
        ...
        <div className="account-card">
          ...
          <strong>{email}</strong>
          {offline && <span className="offline-label">Offline mode</span>}
        ...
        <header className="mobile-header">
          ...
          {mobileOpen && (
            ...
            >
              ...
              <span className="mobile-household">{householdName}</span>
              <button type="button" className="secondary" onClick={onLogout}>
                Log out
              </button>
            </nav>
