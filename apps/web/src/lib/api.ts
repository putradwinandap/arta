...
async function request<T>(path: string, init?: RequestInit): Promise<T> {
  ...
  try {
    ...
    if (error instanceof DOMException && error.name === "AbortError")
      throw new TypeError("request_timeout");
    throw error;
  } finally {
...
export function joinHousehold(token: string) {
  return request<{ householdId: string }>("/api/invites/redeem", {
    method: "POST",
    body: JSON.stringify({ token: token.trim() }),
  });
}
export function getHousehold(h: string) {
  return request<Household>(`/api/households/${h}`);
}
export async function listWallets(h: string) {
  return (await request<{ wallets: Wallet[] }>(`/api/households/${h}/wallets/`))
    .wallets;
}
export function createWallet(
  h: string,
  input: { name: string; type: WalletType; currency: string },
) {
  return request<Wallet>(`/api/households/${h}/wallets/`, {
    method: "POST",
...
export function updateWallet(
  ...
  return request<Wallet>(`/api/households/${h}/wallets/${w}`, {
    method: "PATCH",
    body: JSON.stringify(input),
  });
}
export function archiveWallet(h: string, w: string) {
  return request<Wallet>(`/api/households/${h}/wallets/${w}/archive`, {
    method: "POST",
  });
}
export function createTransaction(
  ...
  return request(`/api/households/${h}/transactions`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
export function createTransfer(
  ...
  return request(`/api/households/${h}/transfers`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
...
export function createCapture(
  ...
  return request<TransactionCapture>(`/api/households/${h}/captures/`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
...
export function reviewCapture(
  ...
  return request<TransactionCapture>(`/api/households/${h}/captures/${c}`, {
    method: "PATCH",
    body: JSON.stringify(input),
  });
}
export function confirmCapture(h: string, c: string) {
  return request(`/api/households/${h}/captures/${c}/confirm`, {
    method: "POST",
  });
}
export function createBudget(
  ...
  return request<BudgetSummary>(`/api/households/${h}/budgets/`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
...
export function createGoal(
  h: string,
  input: { name: string; currency: string; targetAmountMinor: number },
) {
  return request<GoalSummary>(`/api/households/${h}/goals/`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
...
export function updateGoal(
  h: string,
  g: string,
  input: { name: string; targetAmountMinor: number },
) {
  return request<GoalSummary>(`/api/households/${h}/goals/${g}`, {
    method: "PATCH",
    body: JSON.stringify(input),
  });
}
export function archiveGoal(h: string, g: string) {
  return request<GoalSummary>(`/api/households/${h}/goals/${g}/archive`, {
    method: "POST",
  });
}
export function reserveGoal(
  h: string,
  g: string,
  input: { walletId: string; amountMinor: number },
) {
  return request<GoalSummary>(`/api/households/${h}/goals/${g}/reserve`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
export function releaseGoal(
  h: string,
  g: string,
  input: { walletId: string; amountMinor: number },
) {
  return request<GoalSummary>(`/api/households/${h}/goals/${g}/release`, {
    method: "POST",
    body: JSON.stringify(input),
  });
}
...
export async function listReconciliations(h: string) {
  return (
    await request<{ reconciliations: Reconciliation[] }>(
      `/api/households/${h}/reconciliations/`,
    )
  ).reconciliations;
}
